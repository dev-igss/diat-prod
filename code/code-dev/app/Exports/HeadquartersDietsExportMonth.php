...
class HeadquartersDietsExportMonth implements FromView, WithEvents, WithDrawings, WithTitle
{
    /**
    ...
    */
    ...
    function __construct($data){
        ...
        $this->month_in = $data['month_in'];
        $this->services_siigss = ServiceSiigss::select('name')->get();
        $this->datos = DietRequestDetail::whereDate('created_at', $this->month_in)
                ->get();
    ...
    {   
        ...
        return 'Mes '.getMonths(null, $this->month_in).' - '.Carbon::now()->year;
    }
        ...
        return [
            AfterSheet::class    => function(AfterSheet $event){
                ...
                foreach($columnas as $columna){
                    $event->sheet->getDelegate()->getColumnDimension($columna)->setWidth(45, 'px');
                }
                ...
                $event->sheet->getDelegate()->mergeCells('C1:BQ1');
                $event->sheet->getDelegate()->mergeCells('C2:BN2');
                $event->sheet->getDelegate()->mergeCells('BO2:BQ2');
                $event->sheet->getDelegate()->mergeCells('C3:BN3');
                $event->sheet->getDelegate()->mergeCells('C4:BN4');
                $event->sheet->getDelegate()->mergeCells('C5:BN5');
                $event->sheet->getDelegate()->mergeCells('C6:BN6');
                $event->sheet->getDelegate()->mergeCells('BO3:BQ6');
                ...
                $event->sheet->getDelegate()->getStyle('C12:BM52')
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                ...
                $event->sheet->setCellValue('BO2', 'SPS-98');
                $event->sheet->getDelegate()->getStyle('BO2')->getFont()->setBold(true);
                $event->sheet->getDelegate()->getStyle('BO2')->getFont()->setName('Arial');
                $event->sheet->getDelegate()->getStyle('BO2')->getFont()->setSize(12);
                ...
                /* ----------------------------------------------------------------------------------------------------------- */
                $event->getSheet()->getDelegate()->getStyle('A7:BQ52')->applyFromArray(
                    array(
                        'borders' => [
                            'allBorders' => [
                ...
                $event->sheet->getDelegate()->mergeCells('C7:BM7');
                ...
                $event->sheet->getDelegate()->mergeCells('BO7:BQ9');
                $event->sheet->setCellValue('BO7', 'DIETISTA RESPONSABLE');              
                $event->sheet->getDelegate()->getStyle('BO7')->getFont()->setBold(true);
                $event->sheet->getDelegate()->getStyle('BO7')->getFont()->setName('Arial');
                $event->sheet->getDelegate()->getStyle('BO7')->getFont()->setSize(8);
                $event->sheet->getStyle('BO7:BQ9')->getAlignment()->setWrapText(true);

                $event->sheet->getDelegate()->mergeCells('C11:BK11');
                $event->sheet->getDelegate()->mergeCells('BL11:BM11');
                ...
                $event->sheet->getStyle("E10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("H10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("K10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("N10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("Q10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("T10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("W10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("Z10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("AC10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("AF10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("AI10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("AL10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("AO10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("AR10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("AU10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("AX10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("BA10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("BD10")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle("BG10")->getFont()->getColor()->setRGB('2B4C40');
                $event->sheet->setCellValue('BG10', 'C'); 


                $event->sheet->getDelegate()->mergeCells('BH8:BH9');
                $event->sheet->setCellValue('BH8', 'TOTAL');         
                $event->sheet->getStyle('BH8:BH9')->getFill()->applyFromArray(['fillType' => 'solid','rotation' => 0, 'color' => ['rgb' => 'CCC0DA'],]);     
                $event->sheet->getDelegate()->getStyle('BH8')->getFont()->setBold(true);
                $event->sheet->getDelegate()->getStyle('BH8')->getFont()->setName('Arial');
                $event->sheet->getDelegate()->getStyle('BH8')->getFont()->setSize(8);
                $event->sheet->getDelegate()->getStyle("BH8")->getAlignment()->setTextRotation(90);
                $event->sheet->getDelegate()->getStyle('BH8:BH9')
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BH8:BH9')
                                ->getAlignment()
                ...
                $event->sheet->getDelegate()->mergeCells('BI8:BL8');
                $event->sheet->getStyle('BI8:BL8')->getFill()->applyFromArray(['fillType' => 'solid','rotation' => 0, 'color' => ['rgb' => 'FABF8F'],]);
                $event->sheet->setCellValue('BI8', 'REFACCIONES'); 

                $event->sheet->getDelegate()->mergeCells('BI9:BI10');
                $event->sheet->getStyle("BI9:BI10")->getFont()->getColor()->setRGB('60497A');
                $event->sheet->setCellValue('BI9', 'RM');

                $event->sheet->getDelegate()->mergeCells('BJ9:BJ10');
                $event->sheet->getStyle("BJ9:BJ10")->getFont()->getColor()->setRGB('E26B0A');
                $event->sheet->setCellValue('BJ9', 'RV');

                $event->sheet->getDelegate()->mergeCells('BK9:BK10');
                $event->sheet->getStyle("BK9:BK10")->getFont()->getColor()->setRGB('963634');
                $event->sheet->setCellValue('BK9', 'RN');

                $event->sheet->getDelegate()->mergeCells('BL9:BL10');
                $event->sheet->getStyle("BL9:BL10")->getFont()->getColor()->setRGB('0000FF');
                $event->sheet->setCellValue('BL9', 'BANCO DE SANGRE'); 
                $event->sheet->getDelegate()->getStyle('BL9')->getFont()->setSize(8);
                $event->sheet->getStyle('BL9')->getAlignment()->setWrapText(true);
                $event->sheet->getDelegate()->getColumnDimension('BL')->setWidth(80, 'px');

                $event->sheet->getDelegate()->mergeCells('BM8:BM10');
                $event->sheet->getStyle("BM8:BM10")->getFont()->getColor()->setRGB('FF0000');
                $event->sheet->setCellValue('BM8', 'DIETAS DE VIAJE'); 
                $event->sheet->getDelegate()->getColumnDimension('BM')->setWidth(80, 'px');
                $event->sheet->getStyle('BM8')->getAlignment()->setWrapText(true);
                $event->sheet->getDelegate()->getStyle('BM8')->getFont()->setSize(10);
                $event->sheet->getDelegate()->getStyle('BM8:BM10')
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BM8:BM10')
                                ->getAlignment()
                ...
                $event->sheet->getDelegate()->mergeCells('BN7:BN11');
                $event->sheet->setCellValue('BN7', 'TOTAL');           
                $event->sheet->getDelegate()->getStyle('BN7')->getFont()->setBold(true);
                $event->sheet->getDelegate()->getStyle('BN7')->getFont()->setName('Arial');
                $event->sheet->getDelegate()->getStyle('BN7')->getFont()->setSize(8);
                $event->sheet->getDelegate()->getStyle("BN7")->getAlignment()->setTextRotation(90);
                $event->sheet->getDelegate()->getStyle('BN7:BN11')
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BN7:BN11')
                                ->getAlignment()
                ...
                $event->sheet->getStyle("BO10:BO11")->getFont()->getColor()->setRGB('0000FF');
                $event->sheet->setCellValue('BO10', 'D'); 

                $event->sheet->getDelegate()->mergeCells('BP10:BP11');
                $event->sheet->getStyle("BP10:BP11")->getFont()->getColor()->setRGB('FF0000');
                $event->sheet->setCellValue('BP10', 'A'); 

                $event->sheet->getDelegate()->mergeCells('BQ10:BQ11');
                $event->sheet->getStyle("BQ10:BQ11")->getFont()->getColor()->setRGB('2B4C40');
                $event->sheet->setCellValue('BQ10', 'C');
                ...
                $event->sheet->setCellValue('A12', $mes_nombre);
                ...
                $event->sheet->getDelegate()->mergeCells('BL12'.':BL'.$row_count2-1);  
                $event->sheet->getDelegate()->getStyle('BL12'.':BL'.$row_count2-1)
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BL12'.':BL'.$row_count2-1)
                                ->getAlignment()
                ...
                $refacciones = DB::table('diet_requests')
                    ...
                    ->whereMonth('created_at', $this->month_in)
                    ->get();
                $row_count3 = 12;
                $fila_in = 11;
                ...
                $conteo_desayunos = DB::table('diet_request_details')
                    ...
                    ->whereMonth('diet_requests.created_at', $mes)
                ...
                for($i = 0; $i < count($columnas1); $i++){
                    for($j=0; $j < $servicios_siigss_total ; $j++) {
                        if($i == 20){
                            $event->sheet->getStyle('Bl12')->getFont()->getColor()->setRGB('0000FF');
                            foreach($refacciones as $ref){
                                $ref->suma != null ? $event->sheet->setCellValue('BL12', $ref->suma) : $event->sheet->setCellValue('Bl12', 0);
                            }
                            $event->sheet->getDelegate()->getStyle('Bl12')
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                            $event->sheet->getDelegate()->getStyle('Bl12')
                                ->getAlignment()
                        ...
                        $sumrange = 'BL12:BL'.$fila_out;
                        $event->sheet->setCellValue('BL'.$fila_out+1, '=SUM(' . $sumrange . ')');
                        $event->sheet->getStyle('BL'.$fila_out+1)->getFont()->getColor()->setRGB('0000FF');
                ...
                $event->sheet->getStyle('BI'.$fila_out+1)->getFont()->getColor()->setRGB('0000FF');
                    ...
                    for($j=0; $j < $servicios_siigss_total; $j++) {
                        ...
                        for($d = 0; $d < count($conteo_de_viaje); $d++){                             
                            if($conteo_de_viaje[$contador6]->servicio == $services_siigss[$j]->id){
                                $event->sheet->setCellValue('BM'.$row_count4, $conteo_de_viaje[$contador6]->total_dietas);
                            } 
                        ...
                        $event->sheet->setCellValue('BN'.$row_count4, '=BI'.$row_count4.'+BJ'.$row_count4.'+BK'.$row_count4.'+BM'.$row_count4);
                ...
                $event->sheet->getStyle('BJ'.$fila_out+1)->getFont()->getColor()->setRGB('FF0000');
                ...
                $sumrange_BM = 'BM12:BM'.$fila_out;
                $event->sheet->setCellValue('BM'.$fila_out+1, '=SUM(' . $sumrange_BM . ')');
                $event->sheet->getStyle('BM'.$fila_out+1)->getFont()->getColor()->setRGB('FF0000');
                $event->sheet->getDelegate()->getStyle('BM'.$fila_out+1)
                        ->getAlignment()
                        ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BM'.$fila_out+1)
                    ->getAlignment()
                ...
                $sumrange_BN = 'BN12:BN'.$fila_out;
                $event->sheet->setCellValue('BN'.$fila_out+1, '=SUM(' . $sumrange_BN . ')');
                $event->sheet->getStyle('BN'.$fila_out+1)->getFont()->getColor()->setRGB('FF0000');
                $event->sheet->getDelegate()->getStyle('BN'.$fila_out+1)
                        ->getAlignment()
                        ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BN'.$fila_out+1)
                    ->getAlignment()
                ...
                for($i = 0; $i < count($columnas3); $i++){
                    for($j=0; $j < $servicios_siigss_total; $j++) {
                        $event->sheet->getStyle($columnas3[$i].$row_count5)->getFont()->getColor()->setRGB('2B4C40');
                        ...
                        for($d = 0; $d < count($conteo_de_rn); $d++){                             
                            if($conteo_de_rn[$contador10]->servicio == $services_siigss[$j]->id){
                                $event->sheet->setCellValue('BK'.$row_count5, $conteo_de_rn[$contador10]->total_dietas);
                            } 
                ...
                $event->sheet->getStyle('E'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('H'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('K'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('N'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('Q'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('T'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('W'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('Z'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('AC'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('AF'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('AI'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('AL'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('AO'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('AR'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('AU'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('AX'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BA'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BD'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BG'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $sumrange_BK = 'BK12:BK'.$fila_out;
                $event->sheet->setCellValue('BK'.$fila_out+1, '=SUM(' . $sumrange_BK . ')');
                $event->sheet->getStyle('BK'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $conteo_total = DB::table('diet_request_details')
                    ->select(
                        DB::raw('services.name AS nombre'), 
                        DB::raw('services.reporte_siigss AS servicio'), 
                        DB::raw('diet_request_details.iddiet AS dieta'), 
                ...
                for($j=0; $j < $servicios_siigss_total ; $j++) {
                    ...
                    for($d = 0; $d < count($conteo_total); $d++){                             
                        if($conteo_total[$contadorTotal]->servicio == $services_siigss[$j]->id){
                            
                            $event->sheet->setCellValue('BH'.$row_count7, $conteo_total[$contadorTotal]->total_dietas);
                        } 
                ...
                for($j=0; $j < $servicios_siigss_total ; $j++) {
                    ...
                    for($d = 0; $d < count($conteo_desayunos_refacciones_total); $d++){                             
                        if($conteo_desayunos_refacciones_total[$contador17]->servicio == $services_siigss[$j]->id){
                            $event->sheet->setCellValue('BI'.$row_count8, $conteo_desayunos_refacciones_total[$contador17]->total_dietas);
                        } 
                    ...
                    for($d = 0; $d < count($conteo_almuerzos_refacciones_total); $d++){                             
                        if($conteo_almuerzos_refacciones_total[$contador18]->servicio == $services_siigss[$j]->id){
                            $event->sheet->setCellValue('BJ'.$row_count8, $conteo_almuerzos_refacciones_total[$contador18]->total_dietas);
                        } 
                ...
                $columnas4 = [
                    ...
                    'AF','AI','AL','AO','AR','AU','AX','BA','BD','BG','BJ', 'BK', 'BL', 'BM', 'BN'
                ];
                ...
                $event->sheet->getStyle("BO12")->getFont()->getColor()->setRGB('0000FF');
                ...
                $event->sheet->getDelegate()->getStyle('BO12:BO52')
                                ->getAlignment()
                                ->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
                $event->sheet->getDelegate()->mergeCells('BP12:BP52');
                $event->sheet->setCellValue('BP12', $realizado);
                $event->sheet->getStyle("BP12")->getFont()->getColor()->setRGB('FF0000');
                $event->sheet->getDelegate()->getStyle("BP12")->getAlignment()->setTextRotation(90);
                $event->sheet->getDelegate()->getStyle('BP12:BP52')
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BP12:BP52')
                                ->getAlignment()
                                ->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
                $event->sheet->getDelegate()->mergeCells('BQ12:BQ52');
                $event->sheet->setCellValue('BQ12', $realizado);
                $event->sheet->getStyle("BQ12")->getFont()->getColor()->setRGB('2B4C40');
                $event->sheet->getDelegate()->getStyle("BQ12")->getAlignment()->setTextRotation(90);
                $event->sheet->getDelegate()->getStyle('BQ12:BQ52')
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BQ12:BQ52')
                                ->getAlignment()
                ...
                /* Dietas de Personal */
                $event->sheet->getDelegate()->mergeCells('BN38:BN52');
                ...
                for($i = 0; $i < count($columnas3); $i++){
                    for($j=0; $j < 5; $j++) {
                        $event->sheet->getStyle($columnas3[$i].$row_countp)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BD44')->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BG44')->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->setCellValue('BH40', '=BE40+BF40+BG40'); 
                $event->sheet->setCellValue('BH41', '=BE41+BF41+BG41');
                $event->sheet->setCellValue('BH42', '=BE42+BF42+BG42');
                $event->sheet->setCellValue('BH43', '=BE43+BF43+BG43');
                ...
                $event->sheet->getStyle('BI44')->getFont()->getColor()->setRGB('0000FF');
                ...
                $event->sheet->getStyle('BJ44')->getFont()->getColor()->setRGB('FF0000');
                ...
                $event->sheet->setCellValue('BK40', $dietasPersonal['990A']->refaccionNocturna->medicos);
                $event->sheet->setCellValue('BK41', $dietasPersonal['990A']->refaccionNocturna->enfermeria);
                $event->sheet->setCellValue('BK42', $dietasPersonal['990A']->refaccionNocturna->serviciosVarios);
                $event->sheet->setCellValue('BK43', $dietasPersonal['990A']->refaccionNocturna->otros);

                $sumrange_BK = 'BK40:BK43';
                $event->sheet->setCellValue('BK44', '=SUM(' . $sumrange_BK . ')');
                $event->sheet->getStyle('BK44')->getFont()->getColor()->setRGB('2B4C40');
                $event->sheet->getDelegate()->getStyle('BK44')
                        ->getAlignment()
                        ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BK44')
                    ->getAlignment()
                ...
                for($i = 0; $i < count($columnas3); $i++){
                    for($j=0; $j < 7; $j++) {
                        $event->sheet->getStyle($columnas3[$i].$row_countp1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BD50')->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BG50')->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->setCellValue('BH46', '=BE46+BF46+BG46'); 
                $event->sheet->setCellValue('BH47', '=BE47+BF47+BG47');
                $event->sheet->setCellValue('BH48', '=BE48+BF48+BG48');
                $event->sheet->setCellValue('BH49', '=BE49+BF49+BG49');
                ...
                $event->sheet->getStyle('BI50')->getFont()->getColor()->setRGB('0000FF');
                ...
                $event->sheet->getStyle('BJ50')->getFont()->getColor()->setRGB('FF0000');
                ...
                $event->sheet->setCellValue('BK46', $dietasPersonal['990B']->refaccionNocturna->medicos);
                $event->sheet->setCellValue('BK47', $dietasPersonal['990B']->refaccionNocturna->enfermeria);
                $event->sheet->setCellValue('BK48', $dietasPersonal['990B']->refaccionNocturna->serviciosVarios);
                $event->sheet->setCellValue('BK49', $dietasPersonal['990B']->refaccionNocturna->otros);

                $sumrange_BK = 'BK46:BK49';
                $event->sheet->setCellValue('BK50', '=SUM(' . $sumrange_BK . ')');
                $event->sheet->getStyle('BK50')->getFont()->getColor()->setRGB('2B4C40');
                $event->sheet->getDelegate()->getStyle('BK50')
                        ->getAlignment()
                        ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BK50')
                    ->getAlignment()
                ...
                $event->sheet->getStyle('BD51')->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BG51')->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BJ51')->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->setCellValue('BK51', '=BK44+BK50');
                $event->sheet->getStyle('BK51')->getFont()->getColor()->setRGB('2B4C40');
                $event->sheet->getDelegate()->getStyle('BK51')
                        ->getAlignment()
                        ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BK51')
                    ->getAlignment()
                ...
                $columnas5 = [
                    ...
                    'AL', 'AM', 'AN', 'AO', 'AP', 'AQ' ,'AR', 'AS', 'AT', 'AU', 'AV', 'AW', 'AX', 'AY', 'AY', 'AZ',
                ...
                $event->sheet->getStyle("I55")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getDelegate()->mergeCells('BI53:BK54');
                $event->sheet->setCellValue('BI53', 'TOTAL DE REFACCIONES'); 
                $event->sheet->getDelegate()->getStyle('BI53')->getFont()->setSize(6);
                $event->sheet->getDelegate()->getStyle('BI53')->getFont()->setBold(true);
                $event->sheet->getStyle('BI53')->getAlignment()->setWrapText(true);
                $event->sheet->getStyle('BI53:BK54')->getFill()->applyFromArray(['fillType' => 'solid','rotation' => 0, 'color' => ['rgb' => 'FABF8F'],]);
                $event->sheet->getDelegate()->mergeCells('BL53:BL54');
                $event->sheet->setCellValue('BL53', '=BI52+BJ52+BK52+BL52');
                $event->sheet->getDelegate()->getStyle('BL53:BL54')
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BL53:BL54')
                                ->getAlignment()
                ...
                $event->getSheet()->getDelegate()->getStyle('BI53:BL54')->applyFromArray(
                    array(
                        'borders' => [
                            'allBorders' => [
                                'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                ...
                $event->sheet->getDelegate()->mergeCells('BF57:BK57');
                $event->sheet->setCellValue('BF57', 'Total Refacciones Intermedias Pcte.'); 
                $event->sheet->getDelegate()->getStyle('BF57')->getFont()->setBold(true);
                $event->sheet->getStyle('BF57:BK57')->getFill()->applyFromArray(['fillType' => 'solid','rotation' => 0, 'color' => ['rgb' => 'FABF8F'],]);
                $event->sheet->setCellValue('BL57', '=BN37'); 

                $event->sheet->getDelegate()->mergeCells('BF58:BK58');
                $event->sheet->setCellValue('BF58', 'Total Refacciones Nocturnas Personal'); 
                $event->sheet->getDelegate()->getStyle('BF58')->getFont()->setBold(true);
                $event->sheet->getStyle('BF58:BK58')->getFill()->applyFromArray(['fillType' => 'solid','rotation' => 0, 'color' => ['rgb' => 'FABF8F'],]);
                $event->sheet->setCellValue('BL58', '=BK51'); 

                $event->sheet->getDelegate()->mergeCells('BF59:BK59');
                $event->sheet->setCellValue('BF59', 'Total Refacciones Banco de Sangre'); 
                $event->sheet->getDelegate()->getStyle('BF59')->getFont()->setBold(true);
                $event->sheet->getStyle('BF59:BK59')->getFill()->applyFromArray(['fillType' => 'solid','rotation' => 0, 'color' => ['rgb' => 'FABF8F'],]);
                $event->sheet->setCellValue('BL59', '=BL52'); 

                $event->getSheet()->getDelegate()->getStyle('BF57:BL59')->applyFromArray(
                    array(
                        'borders' => [
                            'allBorders' => [
                                'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                ...
                $event->sheet->getDelegate()->getStyle('BF57:BL59')
                                ->getAlignment()
                                ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                $event->sheet->getDelegate()->getStyle('BF57:BL59')
                                ->getAlignment()
                ...
                $event->sheet->getDelegate()->getRowDimension(57)->setRowHeight(40, 'px');
                $event->sheet->getDelegate()->getRowDimension(58)->setRowHeight(40, 'px');
                $event->sheet->getDelegate()->getRowDimension(59)->setRowHeight(40, 'px');
            },
        ];
    }
