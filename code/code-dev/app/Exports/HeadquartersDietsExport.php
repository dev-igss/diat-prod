    ...
    public function registerEvents(): array{
        return [
            AfterSheet::class    => function(AfterSheet $event){
                ...
                $event->sheet->getStyle("BO10:BO11")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BJ'.$fila_out+1)->getFont()->getColor()->setRGB('2B4C40');
                ...
                $conteo_desayunos_refacciones_total = DB::table('diet_request_details')
                    ...
                    ->where('services.reporte_siigss','=', 29)
                    ->where('diet_requests.idjourney', 1)
                    ->where('diet_requests.status', 2)
                    ->groupBy(
                        'services.reporte_siigss')
                ...
                $event->sheet->getStyle("BO12")->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BJ44')->getFont()->getColor()->setRGB('2B4C40');
                ...
                $event->sheet->getStyle('BJ50')->getFont()->getColor()->setRGB('2B4C40');
